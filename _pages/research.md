...
$$
 \Delta = \min \big\{ \frac{R^\ast -  \mathfrak R(d)}{\lVert d^\ast - d \rVert_{\text{TV}}} : d\in N(d^\ast) \big\} = \min \big\{ \frac{r^\top(d^\ast - d)}{\lVert d^\ast - d \rVert_{\text{TV}}} : d\in N(d^\ast) \big\} > 0,
$$
